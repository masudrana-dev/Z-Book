        ...
        <div className='flex'>
            <div className='w-1/2 flex justify-end mr-52 mt-40 '>
                ...
                <div>
                    ...
                    <h3 onClick={handleGoogleSignIn} className=" font-nunito text-base mt-6 flex border border-[#EAEAF0] rounded-lg w-52 p-5 cursor-pointer">
                    ...
                    <p className="font-nunito text-lg mt-8 text-center w-96 ">Dont Have an Account ? <span className="font-bold text-orange-600"> <Link to='/register'>Sign Up</Link></span></p>
                    <p className="font-nunito text-lg mt-8 text-center w-96 "><Link to='/forgotpass'>Forgot Password</Link></p>
                </div>
            </div>
            <div className='w-1/2'>
