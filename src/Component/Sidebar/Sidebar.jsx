    ...
    return (
        <div className='group bg-primary h-screen rounded-lg ml-[32px] pt-[38px]'>
            <div className='relative w-28 h-28 mx-auto'>
                <img src={portfolio} alt="User profile pic" className='mx-auto w-full h-full' />
            ...
            </div>
            {
                ...
                <div className='absolute top-0 left-0 w-full z-50 h-screen bg-slate-400 flex justify-center items-center'>
                    <div className='bg-white w-2/4  p-10 '>
                        {/* {
                            image &&

                            <div className=' .img-preview w-16 h-5'></div>
                        } */}
                        ...
                        <div className='mt-8'>
                            <button type="submit" className=" font-nunito font-bold text-white text-[20px] border border-blue-500 p-3  rounded bg-primary ">Upload</button>
                            <button type="submit" className=" font-nunito font-bold text-white text-[20px] border  p-3  rounded bg-red-500 ml-5 ">Cancel</button>
                        </div>
                    </div>
                </div>
            }
