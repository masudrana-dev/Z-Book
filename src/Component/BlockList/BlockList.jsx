    ...
    return (
        <div className=' mt-10 shadow-gray py-4 h-[420px]  px-3 w-full rounded-lg overflow-y-scroll'>
            <div className='flex justify-between items-center'>
                <h3 className="font-nunito font-semibold pl-[20px] text-[22px]">Block List</h3>
            ...
            <div className="flex items-center px-5 mt-5 border-b-2 border-gray-400 pb-3">
                ...
                <div className="bg-primary font-bold text-white text-[16px] ml-[40px] py-[6px] px-[18px]">Unblock</div>
            </div>
            <div className="flex items-center px-5 mt-5 border-b-2 border-gray-400 pb-3">
                <div>
                    <img src={portfolio} alt="" />
